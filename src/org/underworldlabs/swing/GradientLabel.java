...
/*
    public GradientLabel(String text, ImageIcon icon, int fontSize, 
                         Color foreground, int fontStyle) {
        ...
        * /
        ...
        //leftGradientColor = UIManager.getColor("controlShadow");
        //rightGradientColor = UIManager.getColor("control");
        
        if (leftGradientColor == null) {
            //leftGradientColor = UIManager.getColor("InternalFrame.activeTitleBackground");
            leftGradientColor = UIUtils.getDefaultActiveBackgroundColour();
        }
        
        if (rightGradientColor == null) {
            rightGradientColor = UIUtils.getDefaultInactiveBackgroundColour();
        ...
        if (!UIUtils.isWindowsLookAndFeel()) {
            ...
            label.setForeground(UIUtils.getInverse(leftGradientColor).darker());
            //label.setForeground(UIManager.getColor("TitledBorder.titleColor"));
        }
