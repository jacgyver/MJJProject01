...
public class DockedTabContainer extends JPanel 
    ...
    /** The default divider location for vertical splits */
    ...
    public void closeTabComponent(String name, int position) {
        switch (position) {
            ...
            case SwingConstants.NORTH_EAST:
                if (northTabPane != null) {
                    northTabPane.closeTabComponent(name);
                }
                break;
            ...
            case SwingConstants.SOUTH_EAST:
                if (southTabPane != null) {
                    southTabPane.closeTabComponent(name);
                } 
                else { // wrong position - check north
                    closeTabComponent(name, NORTH);
                }
                break;
            case SwingConstants.CENTER:
                if (scrollingTabPane != null) {
                    scrollingTabPane.closeTabComponent(name);
                }
                break;
        }
    }
    ...
    public TabComponent getComponentAt(int position) {
        switch (position) {
            ...
            case SwingConstants.NORTH_EAST:
                if (northTabPane != null) {
                    return northTabPane.getSelectedComponent();
                }
                break;
            case SwingConstants.SOUTH:
            case SwingConstants.SOUTH_WEST:
            case SwingConstants.SOUTH_EAST:
                if (southTabPane != null) {
                    return southTabPane.getSelectedComponent();
                }
                break;
            case SwingConstants.CENTER:
                if (scrollingTabPane != null) {
                    return scrollingTabPane.getSelectedComponent();
                }
                break;
        }
        return null;
    ...
    public void setToolTipTextForComponent(int position,
        ...
        switch (position) {
            ...
            case SwingConstants.NORTH_WEST:
            case SwingConstants.NORTH_EAST:
                northTabPane.setToolTipTextForComponent(component, toolTipText);
                break;
            case SwingConstants.SOUTH:
            case SwingConstants.SOUTH_WEST:
            case SwingConstants.SOUTH_EAST:
                southTabPane.setToolTipTextForComponent(component, toolTipText);
                break;
            case SwingConstants.CENTER:
                scrollingTabPane.setToolTipTextForComponent(component, toolTipText);
                break;
        }
    }
    ...
    public void setTabTitleForComponent(int position, 
        ...
        switch (position) {
            ...
            case SwingConstants.NORTH_WEST:
            case SwingConstants.NORTH_EAST:
                northTabPane.setTabTitleForComponent(component, title);
                break;
            case SwingConstants.SOUTH:
            case SwingConstants.SOUTH_WEST:
            case SwingConstants.SOUTH_EAST:
                southTabPane.setTabTitleForComponent(component, title);
                break;
            case SwingConstants.CENTER:
                scrollingTabPane.setTabTitleForComponent(component, title);
                break;
        }
    ...
    public void setSelectedIndex(int position, int index) {
        switch (position) {
            ...
            case SwingConstants.NORTH_WEST:
            case SwingConstants.NORTH_EAST:
                northTabPane.setSelectedIndex(index);
                break;
            case SwingConstants.SOUTH:
            case SwingConstants.SOUTH_WEST:
            case SwingConstants.SOUTH_EAST:
                southTabPane.setSelectedIndex(index);
                break;
            case SwingConstants.CENTER:
                scrollingTabPane.setSelectedIndex(index);
                break;
        }        
    }
    ...
    public int getSelectedIndex(int position) {
        switch (position) {
            ...
            case SwingConstants.NORTH_WEST:
            case SwingConstants.NORTH_EAST:
                return northTabPane.getSelectedIndex();
            case SwingConstants.SOUTH:
            case SwingConstants.SOUTH_WEST:
            case SwingConstants.SOUTH_EAST:
                return southTabPane.getSelectedIndex();
            case SwingConstants.CENTER:
                return scrollingTabPane.getSelectedIndex();
        }
        return -1;
    }
    ...
    public void setSelectedPane(int position, String name) {
        ...
        switch (position) {
            ...
            case SwingConstants.SOUTH_EAST:
                ...
                break;
            case SwingConstants.CENTER:
                scrollingTabPane.setSelectedTab(tabComponent);
                break;
        }
    ...
    public int getTabCount(int position) {
        switch (position) {
            ...
            case SwingConstants.NORTH_EAST:
                if (northTabPane != null) {
                    return northTabPane.getTabCount();
                }
                break;
            case SwingConstants.SOUTH:
            case SwingConstants.SOUTH_WEST:
            case SwingConstants.SOUTH_EAST:
                if (southTabPane != null) {
                    return southTabPane.getTabCount();
                }
                break;
            case SwingConstants.CENTER:
                if (scrollingTabPane != null) {
                    return scrollingTabPane.getTabCount();
                }
                break;
        }
        return 0;
    ...
    public List<TabComponent> getOpenTabs(int position) {
        switch (position) {
            ...
            case SwingConstants.NORTH_EAST:
                if (northTabPane != null) {
                    return northTabPane.getTabComponents();
                }
                break;
            case SwingConstants.SOUTH:
            case SwingConstants.SOUTH_WEST:
            case SwingConstants.SOUTH_EAST:
                if (southTabPane != null) {
                    return southTabPane.getTabComponents();
                }
                break;
            case SwingConstants.CENTER:
                if (scrollingTabPane != null) {
                    return scrollingTabPane.getTabComponents();
                }
                break;
        }
        return null;
    ...
    public TabComponent getTabComponent(int position, String title) {
        List<TabComponent> components = null;
        ...
        switch (position) {
            ...
            case SwingConstants.NORTH_EAST:
                if (northTabPane != null) {
                    components = northTabPane.getTabComponents();
                }
                break;
            case SwingConstants.SOUTH:
            case SwingConstants.SOUTH_WEST:
            case SwingConstants.SOUTH_EAST:
                if (southTabPane != null) {
                    components = southTabPane.getTabComponents();
                }
                break;
            case SwingConstants.CENTER:
                if (scrollingTabPane != null) {
                    components = scrollingTabPane.getTabComponents();
                }
                break;
        }
