...
public class UserLayoutProperties implements Serializable,
    ...
    private static Map<String,UserLayoutObject> layoutObjects;
    ...
    public void propertyChange(PropertyChangeEvent e) {
        ...
        SystemProperties.setIntProperty("user", name, value);
    ...
    private synchronized void load() {
        ...
        //Log.info("Loading layout options.");
        
        String confPath = SystemUtilities.getUserPropertiesPath();
        String from = "org/executequery/layout-preferences.xml";
        String to = confPath + "layout-preferences.xml";
    ...
    static class XMLLayoutHandler extends DefaultHandler {
    ...
    static class LayoutInputSource extends InputSource {
    ...
    static class LayoutSorter implements Comparator {
        public int compare(Object obj1, Object obj2) {
            UserLayoutObject value1 = (UserLayoutObject)obj1;
            UserLayoutObject value2 = (UserLayoutObject)obj2;
