...
public class KeywordsDockedPanel extends AbstractDockedTabActionPanel
    ...
    private void init() {
        ...
        searchButton = tools.addButton(this, "search", 
    ...
    private void loadKeywords() {
        ...
        List<String> user = KeywordProperties.getUserDefinedSQL();
    ...
    private void addDatabaseConnectionKewords(DatabaseConnection dc, boolean reset) {
        try {
            MetaDataValues metaData = new MetaDataValues(dc, false);

            // retrieve db keywords
            String[] words = metaData.getDatabaseKeywords();
            // retrieve db product name
            String dbProduct = metaData.getDatabaseProductNameVersion();
            ...
            for (int i = 0; i < words.length; i++) {
                ...
                for (int j = 0, n = keywords.size(); j < n; j++) {
                    ...
                    if (keyword.getText().equals(word)) {
                        ...
                        if (keyword.isUserDefined()) {
                            ...
                            keyword.setDatabaseProductName(dbProduct);
                        }
                        break;
                    }
                ...
                if (!exists) {
                    wordsAdded = true;
                    keywords.add(new SqlKeyword(word, dbProduct, false, true, false));
                }
            }
            ...
            Log.error("Error retrieving database key words for connection " + dc.getName());
        }
    ...
    public void connected(ConnectionEvent connectionEvent) {
        addDatabaseConnectionKewords(connectionEvent.getSource(), true);
    ...
    private class KeywordComparator implements Comparator {
        public int compare(Object obj1, Object obj2) {
            String text1 = ((SqlKeyword)obj1).getText();
            String text2 = ((SqlKeyword)obj2).getText();
