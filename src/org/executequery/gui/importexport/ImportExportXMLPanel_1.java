...
public class ImportExportXMLPanel_1 extends JPanel  {
    ...
    private void jbInit() throws Exception {
        ...
        if (type == ImportExportProcess.EXPORT) {
            ...
            append("export also allows for a single file for all tables separated ").
            append("using relevant XML tags or a separate file for each table.");
        } 
