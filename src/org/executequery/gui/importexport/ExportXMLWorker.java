...
public class ExportXMLWorker extends AbstractImportExportWorker 
    ...
    /** Utility class to retrieve DB metadata */
    ...
    private Object doWork() {
        ...
        Vector transfers = getParent().getDataFileVector();
        ...
        try {
            ...
            for (int i = 0; i < transfers_size; i++) {
                ...
                DataTransferObject obj = (DataTransferObject)transfers.elementAt(i);
    ...
    class TableDataParser implements XMLReader {
        ...
        // --- define the XML tags ---
        // ---------------------------
        private final String rootElement = "schema";
        private final String NAME = "name";
        private final String schemaUrlAtt = "jdbcurl";
        private final String schemaUserAtt = "user";
        private final String tableNode = "table";
        private final String rowAttNode = "rownum";
        private final String rowNode = "row";
        private final String newLine_s = "\n";
        private final String attType1 = "CDATA";
        private final String attType2 = "ID";
        
        // -------------------------------
        // --- define the line indents ---
        // -------------------------------
        private final String indent_1 = "\n   ";
