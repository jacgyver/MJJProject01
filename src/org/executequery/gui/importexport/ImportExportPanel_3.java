...
public class ImportExportPanel_3 extends JPanel {
    ...
    public void buildTable() {
        ...
        switch (type) {
            ...
            case ImportExportProcess.MULTIPLE_TABLE:
                ...
                if (hasData) {
                    Vector v_current = tableModel.getDataVector();
    ...
    /** <p>Defines the table model for the table to file
    ...
    class TableTransferModel extends AbstractTableModel {
        ...
        /** <p>Constructs a new table model with no data. */
        public TableTransferModel() {}
        
        /** <p>Constructs a new table model with the specified data.
         *
         *  @param the data to be displayed
         */
        public TableTransferModel(Vector data) {
            this.data = data;
        }
    ...
    class BrowseButtonRenderer extends JButton
