...
public class ImportXMLPanel_4 extends JPanel {
    ...
    private void jbInit() throws Exception {
        ...
        JLabel sampleLabel = new JLabel(
                "Click the [Sample] button for an example of what is expected.");
    ...
    static class SampleDialog extends JDialog 
        ...
        public SampleDialog() {
            ...
            closeButton.setPreferredSize(Constants.FORM_BUTTON_SIZE);
