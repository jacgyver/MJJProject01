...
public class ErdViewerPanel extends DefaultTabView
    ...
    public void resetTableValues(Vector tableNames, Vector columnData) {
        removeAllTables();
        setTables(tableNames, columnData);
        dependsPanel.setTableDependencies(buildTableRelationships());
        resizeCanvas();
    ...
    public void setTables(Vector tableNames, Vector columnData) {
        ...
        for (int i = 0; i < v_size; i++) {
            ...
            table = new ErdTable((String)tableNames.elementAt(i),
                                 (ColumnData[])columnData.elementAt(i), this);
    ...
    public PageFormat getPageFormat() {
        return SystemUtilities.getPageFormat();
    }
    ...
    public void setSavedErd(ErdSaveFileFormat _savedErd, String absolutePath) {
        ...
        for (int i = 0; i < fileData.length; i++) {
            ...
            table.setTableBackground(_savedErd.getTableBackground());
    ...
    public boolean tabViewClosing() {
        ...
        if (SystemUtilities.isPromptingToSave()) {
