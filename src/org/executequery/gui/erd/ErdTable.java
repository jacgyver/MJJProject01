...
public class ErdTable extends ErdMoveableComponent
    ...
    private ErdTableConnectionPoint[] verticalLeftJoins;
    private ErdTableConnectionPoint[] verticalRightJoins;
    private ErdTableConnectionPoint[] horizontalTopJoins;
    private ErdTableConnectionPoint[] horizontalBottomJoins;
...
/*      if (!newTable)
    ...
    class ErdTableConnectionPoint implements Serializable {
